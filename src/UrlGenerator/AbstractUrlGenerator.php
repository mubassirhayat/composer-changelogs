...
/**
 * @deprecated since v1.3, will be removed in v2.0. Use GitBasedUrlGenerator class instead.
 */
abstract class AbstractUrlGenerator extends GitBasedUrlGenerator
{
     ...
     * @return string
     *
     * @deprecated since v1.3, will be removed in v2.0. Use $version->isDev() instead.
     */
